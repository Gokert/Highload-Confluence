...
```
1.55 + 0.016 + 0.015 = 1.56 ГБ/с
```

Cуммарный суточного трафик: 
```
(97.2 * 11 + 0.97 * 11 + 19.4 * 0.5) * (24 * 60 * 60) = 94 138 848 МБ/сутки = 0.088 ПТ/сутки
```
...
| Пиковое потребление в течении суток |  1.56 ГБ/сек   |
| Суммарный суточный                  | 0.088 ПТ/сутки |
...
| Documents   | 127.3 |  2  | 2 Гб | 1.56 ГБ/с |
...
| Сервис           | Хостинг | Конфиг                  | Кол-во | Цена аренды $/ед |
|------------------|---------|-------------------------|--------|------------------|
| nginx            | Azure   | 1 core CPU/ 1x2 GB RAM  | 7      | 30               |
| permission       | Azure   | 2 core CPU/ 1x2 GB RAM  | 7      | 60               |
| search           | Azure   | 1 core CPU/ 1x2 GB RAM  | 7      | 30               |
| documents        | Azure   | 2 core CPU/ 1x2 GB RAM  | 7      | 60               |
| outbox processor | Azure   | 1 core CPU/ 1x2 GB RAM  | 7      | 30               |
| worker           | Azure   | 1 core CPU/ 1x2 GB RAM  | 7      | 30               |
| PostgreSQL       | Azure   | 1 core CPU/ 1x2 GB RAM/ | 42     | -                |
| ClickHouse       | Azure   | 1 core CPU/ 1x2 GB RAM/ | 14     | -                |
| Redis            | Azure   | 1 core CPU/ 1x2 GB RAM/ | 7      | -                |
| Kafka            | Azure   | 1 core CPU/ 1x2 GB RAM/ | 21     | -                |
| CEPH             | Azure   | 1 core CPU/ 1x2 GB RAM/ | 14     | -                |
