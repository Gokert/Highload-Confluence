...
Найдём среднее число картинок на документ. В среднем одна картинка равняется 500 КБ. Из общего среднего веса картинки вычтем вес текста и делим на средний размер картинки.
```
